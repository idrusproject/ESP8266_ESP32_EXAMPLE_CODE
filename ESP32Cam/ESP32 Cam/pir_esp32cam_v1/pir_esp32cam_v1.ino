const char* ssid     = "Idrus";   //WIFI SSID
const char* password = "082322631658";   //WIFI password
String token = "1398662534:AAGqxQwxN3rcfbdS3mOzEe0W4WlooWLFSgs";
...
void loop(){
  ...
  Serial.println(digitalRead(gpioPIR));
  if (digitalRead(gpioPIR)==1){
